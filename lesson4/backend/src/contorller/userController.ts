...
class UserController {
    public async getUserByEmail(req: Request, res: Response, next: NextFunction): Promise<void | Error> {
        try {
    ...
    public async getAllUsers(req: Request, res: Response, next: NextFunction): Promise<void | Error> {
        try {
    ...
    public async deleteById(req: Request, res: Response, next: NextFunction): Promise<void | Error> {
        try {
            const { id } = req.params;
    ...
    public async updateById(req: Request, res: Response, next: NextFunction): Promise<void | Error> {
        try {
            const { id } = req.params;
    ...
    public async getUserPagination(req: Request, res: Response, next: NextFunction): Promise<void | Error> {
        try {
            const {
                page,
                perPage,
