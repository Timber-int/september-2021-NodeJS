...
import { authService, emailService, fileService, tokenService, userService, } from '../services';
...
class AuthController {
    public async registration(req: Request, res: Response, next: NextFunction): Promise<void | Error> {
        try {
            ...
            if (avatar) {
                await fileService.saveFile(avatar);
    ...
    public async sendMailUserWhoForgotPassword(req: IRequestExtended, res: Response, next: NextFunction): Promise<void | Error> {
        try {
            const user = req.user as IUser;
    ...
    public async setNewPasswordForUser(req: IRequestExtended, res: Response, next: NextFunction): Promise<void | Error> {
        try {
            const user = req.user as IUser;
