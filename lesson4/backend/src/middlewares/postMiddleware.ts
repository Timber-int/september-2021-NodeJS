...
class PostMiddleware {
    public async checkIsUserByIdExist(req: IRequestExtended, res: Response, next: NextFunction): Promise<void | Error> {
        try {
    ...
    public async checkIsPostTitleUnique(req: IRequestExtended, res: Response, next: NextFunction): Promise<void | Error> {
        try {
