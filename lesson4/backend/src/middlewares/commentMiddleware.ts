...
class CommentMiddleware {
    public async checkIsAuthorComment(req: IRequestExtended, res: Response, next: NextFunction): Promise<void | Error> {
        try {
    ...
    public async checkIsPostComment(req: IRequestExtended, res: Response, next: NextFunction): Promise<void | Error> {
        try {
